 ...
 *
 * Implementation of state serialization for FabricRichText.
...
#define STATE_LOG_TAG "FabricRichTextState"
...
folly::dynamic FabricRichTextState::getDynamic() const {
