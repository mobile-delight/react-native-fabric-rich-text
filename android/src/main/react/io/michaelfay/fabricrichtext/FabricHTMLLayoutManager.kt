 ...
 */
@DoNotStrip
object FabricRichLayoutManager {
    ...
    private fun createBuilder(): FabricRichSpannableBuilder = FabricRichSpannableBuilder()
     ...
     * Called by FabricRichTextView during rendering.
     *
