...
/**
 * Parses MapBuffer from C++ FabricRichTextViewState into TextFragment objects.
 *
 ...
 */
object FabricRichFragmentParser {
    private const val TAG = "FabricRichFragmentParser"
    private const val DEBUG = false

    // State keys (from FabricRichTextViewState.cpp)
     ...
     * This replaces the FabricRichSpannableBuilder for state-based rendering.
     *
