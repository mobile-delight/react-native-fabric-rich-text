...
describe('RichText.web', () => {
  ...
  it('should return null for null html prop', () => {
    const { container } = render(<RichText html={null as unknown as string} />);
    expect(container.firstChild).toBeNull();
  });
  ...
  describe('Semantic HTML Output', () => {
    it('should render <strong> tag as semantic strong element', () => {
      const { container } = render(
        <RichText html="<strong>Bold text</strong>" />
      );
    ...
    it('should render <em> tag as semantic em element', () => {
      const { container } = render(<RichText html="<em>Italic text</em>" />);
    ...
    it('should render <p> tag as semantic p element', () => {
      const { container } = render(<RichText html="<p>Paragraph text</p>" />);
    ...
    it('should render <h1> tag as semantic h1 element', () => {
      const { container } = render(<RichText html="<h1>Heading text</h1>" />);
    ...
    it('should preserve nested semantic structure', () => {
      const { container } = render(
        <RichText html="<p><strong>Bold in paragraph</strong></p>" />
      );
      const pElement = container.querySelector('p');
  ...
  describe('Style Prop Integration', () => {
    it('should apply fontSize style to root element', () => {
      const { container } = render(
        <RichText html="<p>Text</p>" style={{ fontSize: 16 }} />
      );
    ...
    it('should apply color style to root element', () => {
      const { container } = render(
        <RichText html="<p>Text</p>" style={{ color: '#FF0000' }} />
      );
      const rootElement = container.firstChild as HTMLElement;
    ...
    it('should handle undefined style without crashing', () => {
      const { container } = render(<RichText html="<p>Text</p>" />);
  ...
  describe('className Prop Integration', () => {
    it('should apply className to root element', () => {
      const { container } = render(
        <RichText html="<p>Text</p>" className="text-blue-500" />
      );
      const rootElement = container.firstChild as HTMLElement;
  ...
  describe('testID Prop Integration', () => {
    it('should apply testID as data-testid attribute', () => {
      const { getByTestId } = render(
        <RichText html="<p>Text</p>" testID="my-component" />
      );
  ...
  describe('Edge Case Handling', () => {
    it('should render deeply nested tags without stack overflow', () => {
      ...
      const { container } = render(<RichText html={deeplyNested} />);
    ...
    it('should render very long HTML without performance degradation', () => {
      ...
      const { container } = render(<RichText html={longHtml} />);
    ...
    it('should handle special characters correctly', () => {
      const { container } = render(<RichText html="<p>&amp; &lt; &gt;</p>" />);
      const pElement = container.querySelector('p');
  ...
  describe('XSS Protection', () => {
    it('should sanitize script tags', () => {
      const { container } = render(
        <RichText html="<script>alert('xss')</script><p>Safe</p>" />
      );
    ...
    it('should sanitize event handler attributes', () => {
      const { container } = render(
        <RichText html='<p><img src=x onerror="alert(1)"></p>' />
      );
    ...
    it('should sanitize javascript protocol in links', () => {
      ...
      const { container } = render(<RichText html={maliciousHtml} />);
    ...
    it('should allow safe links', () => {
      const { container } = render(
        <RichText html='<a href="https://example.com">Link</a>' />
      );
      const link = container.querySelector('a');
    ...
    it('should sanitize data attributes with event handlers', () => {
      const { container } = render(
        <RichText html='<p data-onclick="alert(1)">Text</p>' />
      );
      const p = container.querySelector('p');
    ...
    it('should sanitize iframe tags', () => {
      const { container } = render(
        <RichText html='<iframe src="https://evil.com"></iframe><p>Safe</p>' />
      );
    ...
    it('should sanitize object and embed tags', () => {
      const { container } = render(
        <RichText html='<object data="malicious.swf"></object><p>Safe</p>' />
      );
    ...
    it('should sanitize style tags with malicious CSS', () => {
      const { container } = render(
        <RichText html="<style>body { display: none; }</style><p>Visible</p>" />
      );
    ...
    it('should sanitize svg with script elements', () => {
      const { container } = render(
        <RichText html="<svg><script>alert(1)</script></svg><p>Safe</p>" />
      );
