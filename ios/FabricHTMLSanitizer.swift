...
@objc public final class FabricHTMLSanitizer: NSObject {
  /**
  ...
  public override init() {
    ...
    do {
      ...
      #if DEBUG
        print("FabricHTMLSanitizer: Failed to configure allowlist: \(error)")
      #endif
    }
  ...
  @objc public func sanitize(_ html: String) -> String {
    ...
    do {
      ...
      NSLog("FabricHTMLSanitizer: Failed to sanitize HTML: %@", String(describing: error))
      return ""
    }
  }
}
